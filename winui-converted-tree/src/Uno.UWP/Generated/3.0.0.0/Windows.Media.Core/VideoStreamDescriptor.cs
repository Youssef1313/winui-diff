...
namespace Windows.Media.Core
{
	...
	public partial class VideoStreamDescriptor : global::Windows.Media.Core.IMediaStreamDescriptor, global::Windows.Media.Core.IMediaStreamDescriptor2
	{
		...
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor.IsSelected.get
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor.Language.get
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor.Language.set
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor.Name.get
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor.Name.set
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor2.Label.get
		// Forced skipping of method Windows.Media.Core.VideoStreamDescriptor.Windows.Media.Core.IMediaStreamDescriptor2.Label.set
#if __ANDROID__ || __IOS__ || IS_UNIT_TESTS || __WASM__ || __SKIA__ || __NETSTD_REFERENCE__ || __MACOS__
		[global::Uno.NotImplemented("__ANDROID__", "__IOS__", "IS_UNIT_TESTS", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__")]
